...
{ 
    ...
    { 
        ...
        public DataPolicySimple DataPolicy { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TeamDataPolicyDetailedTransient {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((TeamDataPolicyDetailedTransient)obj);
        }

        /// <summary>
        /// Returns true if TeamDataPolicyDetailedTransient instances are equal
        /// </summary>
        /// <param name="other">Instance of TeamDataPolicyDetailedTransient to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TeamDataPolicyDetailedTransient other)
        {
            ...
            return 
                ...
                (
                    ...
                    DataPolicy != null &&
                    DataPolicy.Equals(other.DataPolicy)
                ) && 
                (
                    RState == other.RState ||
                    RState != null &&
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                // Suitable nullity checks etc, of course :)
                    ...
                    if (DataPolicy != null)
                    hashCode = hashCode * 59 + DataPolicy.GetHashCode();
                    if (RState != null)
        ...
        public static bool operator ==(TeamDataPolicyDetailedTransient left, TeamDataPolicyDetailedTransient right)
        {
