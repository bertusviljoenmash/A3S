...
{ 
    ...
    { 
        /// <summary>
        /// Approve all current transient states for a function.
        /// </summary>
        /// <remarks>Approve all current transient states for a function, given the function&#39;s UUID.</remarks>
        ...
        [HttpPatch]
        [Route("/functions/{functionId}/approve", Name = "ApproveFunction")]
        [ValidateModelState]
        [ProducesResponseType(statusCode: 200, type: typeof(FunctionTransient))]
        ...
        public abstract Task<IActionResult> ApproveFunctionAsync([FromRoute][Required]Guid functionId);
        ...
        /// <summary>
        /// Decline all current transient states for a function.
        /// </summary>
        /// <remarks>Decline all current transient states for a function, given the function&#39;s UUID.</remarks>
        /// <param name="functionId">The UUID of the function.</param>
        /// <response code="200">OK.</response>
        /// <response code="400">Bad Request.</response>
        /// <response code="401">Not authenticated.</response>
        ...
        /// <response code="500">An unexpected error occurred.</response>
        [HttpPatch]
        [Route("/functions/{functionId}/decline", Name = "DeclineFunction")]
        [ValidateModelState]
        [ProducesResponseType(statusCode: 200, type: typeof(FunctionTransient))]
        [ProducesResponseType(statusCode: 400, type: typeof(ErrorResponse))]
        [ProducesResponseType(statusCode: 401, type: typeof(ErrorResponse))]
        ...
        [ProducesResponseType(statusCode: 422, type: typeof(ErrorResponse))]
        [ProducesResponseType(statusCode: 500, type: typeof(ErrorResponse))]
        public abstract Task<IActionResult> DeclineFunctionAsync([FromRoute][Required]Guid functionId);
        ...
        /// <summary>
        /// Get the current active (all transients since last declined or released state) for a function and it&#39;s relations.
        /// </summary>
        /// <remarks>Get the latest transients for a function by the function&#39;s UUID.</remarks>
        /// <param name="functionId">The UUID of the function.</param>
        /// <response code="200">OK.</response>
        /// <response code="400">Bad Request.</response>
        /// <response code="401">Not authenticated.</response>
        ...
        /// <response code="500">An unexpected error occurred.</response>
        [HttpGet]
        [Route("/functions/{functionId}/transients", Name = "GetFunctionTransients")]
        [ValidateModelState]
        [ProducesResponseType(statusCode: 200, type: typeof(FunctionTransients))]
        [ProducesResponseType(statusCode: 400, type: typeof(ErrorResponse))]
        [ProducesResponseType(statusCode: 401, type: typeof(ErrorResponse))]
        [ProducesResponseType(statusCode: 403, type: typeof(ErrorResponse))]
        [ProducesResponseType(statusCode: 404, type: typeof(ErrorResponse))]
        [ProducesResponseType(statusCode: 500, type: typeof(ErrorResponse))]
        public abstract Task<IActionResult> GetFunctionTransientsAsync([FromRoute][Required]Guid functionId);
