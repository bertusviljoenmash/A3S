...
namespace za.co.grindrodbank.a3s.Repositories
{
    public interface IApplicationRepository : ITransactableRepository, IPaginatedRepository<ApplicationModel>
    {
        ...
        Task<PaginatedResult<ApplicationModel>> GetPaginatedListAsync(int page, int pageSize, string filterName, string filterFunctionName, List<KeyValuePair<string, string>> orderBy);
